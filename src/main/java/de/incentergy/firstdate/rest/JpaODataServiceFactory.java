package de.incentergy.firstdate.rest;
...
public class JpaODataServiceFactory extends ODataJPAServiceFactory {
	...
	public ODataJPAContext initializeODataJPAContext() throws ODataJPARuntimeException {
		...
		try {
			...
			EntityManager entityManager = (EntityManager) initialContext.lookup("java:/firstDateEntityManager");
			...
			EntityManagerFactory entityManagerFactory = (EntityManagerFactory) initialContext
					.lookup("java:/firstDateEntityManagerFactory");
			oDataJPAContext.setEntityManagerFactory(entityManagerFactory);
			oDataJPAContext.setPersistenceUnitName("first-date-questions");
